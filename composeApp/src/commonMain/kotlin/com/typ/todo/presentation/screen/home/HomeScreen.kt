...
import com.typ.todo.presentation.components.ErrorScreen
import com.typ.todo.presentation.components.LoadingScreen
import com.typ.todo.presentation.components.TaskView
import com.typ.todo.presentation.screen.task.TaskScreen
...
class HomeScreen : Screen {
    ...
    override fun Content() {
        ...
        Scaffold(
            topBar = {
                CenterAlignedTopAppBar(title = { Text(text = "Task Journal") })
            },
