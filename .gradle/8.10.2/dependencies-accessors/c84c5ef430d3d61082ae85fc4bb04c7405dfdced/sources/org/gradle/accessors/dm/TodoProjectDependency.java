...
@NonNullApi
public class TodoProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TodoProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
